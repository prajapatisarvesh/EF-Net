...
def test_all_methods():
    ...
    for batch_idx, (data, targets) in enumerate(test):
        ...
        ax[0,1].set_title('Prediction', fontsize=20)
        ax[0,2].set_title('True', fontsize=20)
        ...
        ax[2][1].plot(preds3)
        ax[2][2].plot(mask3)
        # plt.savefig('plots/efnet.png', bbox_inches='tight')
        plt.show()
        break
    ...
    for x,y in test:
        ...
        ax[0,1].set_title('Prediction UNETR', fontsize=16)
        ax[0,2].set_title('Prediction SRCNN', fontsize=16)
        ax[0,3].set_title('Mask Regression', fontsize=16)
        ax[0,4].set_title('Prediction UNETS', fontsize=16)
        ax[0,5].set_title('Mask Segmentation', fontsize=16)
        # ax[1,0].set_title('Image')
