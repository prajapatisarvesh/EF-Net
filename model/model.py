...
class UNet(nn.Module):
    ...
    def __init__(self,out_channels=60,features=[64, 128, 256, 512]):
        ...
        self.convtranspose1 = nn.ConvTranspose2d(features[-1]*2, features[-1], kernel_size=2, stride=2)
        self.convtranspose2 = nn.ConvTranspose2d(features[-1], features[-2], kernel_size=2, stride=2)
        self.convtranspose3 = nn.ConvTranspose2d(features[-2], features[-3], kernel_size=2, stride=2)
        self.convtranspose4 = nn.ConvTranspose2d(features[-3], features[-4], kernel_size=2, stride=2)
